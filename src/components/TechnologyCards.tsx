...
const TechCard = ({ 
  ...
  className = '', 
  icon = <Sparkles className="h-5 w-5 text-blue-600 dark:text-blue-300" /> 
}: TechCardProps) => {
  return (
    <div className={cn(
      ...
      <div className="space-y-4 text-center">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white mt-2 transition-transform duration-300">{title}</h3>
        ...
        <div className="pt-2 flex justify-center opacity-0 transform translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
          <ArrowRight className="h-5 w-5 text-gray-400 dark:text-gray-300 group-hover:text-blue-500" />
        </div>
      </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
      <TechCard
        ...
        icon={<Database className="h-5 w-5 text-blue-600 dark:text-blue-300" />}
      ...
      <TechCard
        ...
        lineColor="bg-teal-500 dark:bg-teal-400"
        bgColor="bg-teal-50 dark:bg-teal-900/30"
        accentColor="border-teal-200 dark:border-teal-700"
        iconBg="bg-teal-100 dark:bg-teal-800/50"
        icon={<Brain className="h-5 w-5 text-teal-600 dark:text-teal-300" />}
      ...
      <TechCard
        ...
        lineColor="bg-amber-500 dark:bg-amber-400"
        bgColor="bg-amber-50 dark:bg-amber-900/30"
        accentColor="border-amber-200 dark:border-amber-700"
        iconBg="bg-amber-100 dark:bg-amber-800/50"
        icon={<BarChart className="h-5 w-5 text-amber-600 dark:text-amber-300" />}
